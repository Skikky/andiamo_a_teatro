...
import com.example.andiamo_a_teatro.exception.CustomAccessDeniedEntryPoint;
import com.example.andiamo_a_teatro.exception.CustomAuthenticationEntryPoint;
import com.example.andiamo_a_teatro.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> req
                        .requestMatchers("/swagger-ui/**","/v3/api-docs/**", "/auth/register/**", "/auth/login/**", "/auth/confirm/**")
                        .permitAll()
                        .anyRequest()
                        .authenticated()
                )
    ...
    public AccessDeniedHandler customAccessDeniedHandler() {
        return new CustomAccessDeniedEntryPoint();
    }
}
